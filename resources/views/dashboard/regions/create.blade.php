    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2"> @lang('site.add_region') </h4>
            </div>
            <div class="modal-body">
               
                <form class="form-horizontal form-label-left" action="{{ route('admin.region.store') }}" method="post">
                    @csrf
                 
                <input type="hidden" name="country_id" value="{{ $item->id }}" />
