...
@section('content')
    ...
    <form class="form-horizontal form-label-left" action="{{ route('admin.region.store',$item->id) }}" method="post" novalidate>
        @csrf
        ...
        <div class="form-group">
            ...
            <button type="button" onclick="location.href='{{ route('admin.regions',$item->country_id) }}'" class="btn btn-primary"> 
