...
<form action="{{ route('admin.user.search') }}" method="get" class="form-horizontal form-label-left">
        ...
        <div class="form-group col-md-5">
            <label class="col-md-4 col-sm-3 col-xs-12"> @lang('site.mobile') </label>
        ...
        <div class="form-group col-md-5">
            <label class="col-md-4 col-sm-3 col-xs-12"> @lang('site.country') </label>
        ...
        <div class="form-group col-md-5">
            <label class="col-md-4 col-sm-3 col-xs-12"> @lang('site.city') </label>
