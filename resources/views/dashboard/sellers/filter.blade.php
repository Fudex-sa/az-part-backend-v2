...
<form action="{{ route('admin.seller.search') }}" method="get" class="form-horizontal form-label-left">
 
        <div class="form-group col-md-5">
            <label class="col-md-5 col-sm-3 col-xs-12"> @lang('site.store_name') </label>
