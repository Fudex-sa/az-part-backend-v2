    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2"> @lang('site.import_supervisors') </h4>
            </div>
            <div class="modal-body">

                <form class="form-horizontal form-label-left" action="{{ route('admin.supervisors.import') }}" method="post" enctype="multipart/form-data">
                    @csrf
