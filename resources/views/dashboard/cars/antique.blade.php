...
<table class="table table-striped jambo_table bulk_action" id="myTbl">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>@if($item->img != '') <img src="{{asset('uploads/'.$item->img)}}" class="img-tbl"/>
                @else <img src="{{asset('templates/images/logo.png')}}" class="img-tbl"/> @endif
            </td>
            ...
            <td>
                <a href="{{ route('admin.car.antique.edit',$item->id) }}" class="btn btn-info btn-xs"> <i class="fa fa-edit"></i> </a>
