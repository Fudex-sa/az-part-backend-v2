...
<div class="" role="tabpanel" data-example-id="togglable-tabs">
    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade  active in" id="tab_content1" aria-labelledby="car_details">
            ...
            <form class="form-horizontal form-label-left" action="{{ route('admin.car.antique.store',$item->id) }}"
               ...
               <div class="item form-group">
                ...
                <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="car_type">   </label>
