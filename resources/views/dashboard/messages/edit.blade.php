...
@section('content')
    ...
    <form class="form-horizontal form-label-left" action="{{ route('admin.message.store',$item->id) }}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="msg" class="form-control col-md-7 col-xs-12" 
                required value="{{ $item->msg }}" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <button type="button" onclick="location.href='{{ route('admin.messages') }}'" class="btn btn-primary"> 
